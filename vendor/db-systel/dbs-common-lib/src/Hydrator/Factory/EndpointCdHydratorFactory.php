...
class EndpointCdHydratorFactory implements FactoryInterface
{
    ...
    public function createService(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $endpointHydrator->addStrategy('physical_connection', new GenericEntityStrategy($physicalConnectionHydrator, new PhysicalConnectionCd()));
